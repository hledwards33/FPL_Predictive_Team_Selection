...
def data_transformations(dataframe, date_field, player_field, team_field, input_data_path, team_rating_data):
    ...
    # Drop element, round & fixture fields from the dataframe because these are unique references
    dataframe.drop(['element', 'fixture', 'round', 'transfers_balance'], axis=1, inplace=True)
